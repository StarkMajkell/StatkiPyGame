        ...
        while True:
            ...
            if 212 < mouse[0] < 382:
                ...
                if click[0]:
                    ...
                    rollmstatic+=rollm
                    rollm=0
            obraz.blit(player1, [213, 13+rollm+rollmstatic])
            obraz.blit(staty, [213, 0+rollm+rollmstatic])
            if 172 < mouse[0] < 212 and 80 < mouse[1] < 120+rollm+rollmstatic:
                if click[0]:
                    obraz.blit(przycisk4, [172, 80+rollm+rollmstatic])
                    lista_statków[0].basehp +=1
                else:
                    obraz.blit(przycisk2, [172, 80+rollm+rollmstatic])
            if 380< mouse[0] < 420 and 80 < mouse[1] < 120+rollm+rollmstatic:
                if click[0]:
                    obraz.blit(przycisk3, [380, 80+rollm+rollmstatic])
                    if lista_statków[0].basehp > 1:
                        lista_statków[0].basehp -= 1
                else:
                    obraz.blit(przycisk2, [380, 80+rollm+rollmstatic])

            obraz.blit(przycisk4, [172, 160+rollm+rollmstatic])
            obraz.blit(przycisk3, [380, 160+rollm+rollmstatic])
            obraz.blit(przycisk4, [172, 240+rollm+rollmstatic])
            obraz.blit(przycisk3, [380, 240+rollm+rollmstatic])
            obraz.blit(przycisk4, [172, 320+rollm+rollmstatic])
            obraz.blit(przycisk3, [380, 320+rollm+rollmstatic])
            obraz.blit(przycisk4, [172, 400+rollm+rollmstatic])
            obraz.blit(przycisk3, [380, 400+rollm+rollmstatic])
            obraz.blit(przycisk4, [172, 480+rollm+rollmstatic])
            obraz.blit(przycisk3, [380, 480+rollm+rollmstatic])
