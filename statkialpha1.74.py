    ...
    if opcjemenu == 3:
        ...
        while True:
            ...
            if click[0] and 203 < mouse[0] < 254 and 617 < mouse[1] < 663 and zmiennatrzymaszturet == 0 and kasa >= 40:
                lista_turet.append(Turet(203, 617, 3, 130, 2, 2, 10,700,40))
                kasa-=40
                    ...
                    if zasieg(i.x, i.y, j.x, j.y, i.range) == 1:
                        if i.magazynek>=i.firerate:
                            ...
                            if i.wartosc==30:
                                ...
                                my_missile_list.append(Projectile(i.x+25,i.y+25,-(i.x - j.x)*0.05-j.vx,-(i.y - j.y)*0.05-j.vy,0,pocisk5,i.dmg,i.range,1))
                            i.magazynek=0
                ...
                for bb in lista_enemy:
                    ...
                    if b.typpocisku ==1:
                        ...
                        if b.target==bb:
                            if bb.istnieje == 0:
                                b.istnieje=0
                            if b.rakietonspeed > 0.3:
                                b.rakietonspeed -= 0.3
                            b.vx = -(b.x - bb.x)/b.rakietonspeed
                            b.vy = -(b.y - bb.y)/b.rakietonspeed
            ...
            if globalnytimer == 5:
                if lokalnytimer2 < 35:
                    ...
                    lokalnytimer2 = 0
                    lista_enemy.append(Enemy(listakropekkordyx[0], listakropekkordyy[0], 1, 50000, 0, 0, 10))
