...
def hitBox(pozycjax,pozycjay,pozycjax2,pozycjay2,rozmiar):
    if (pozycjax + rozmiar >= pozycjax2) and (pozycjax -rozmiar <= pozycjax2) and (pozycjay +rozmiar >= pozycjay2) and (pozycjay -rozmiar <= pozycjay2):
        return 1
                ...
                for i in range(x, y):
                    if i != x:
                        if hitBox(lista_statków[x].x, lista_statków[x].y, lista_statków[i].x, lista_statków[i].y,
                                  60) == 1:
                            print(lista_statków[x].player, lista_statków[i].player)
