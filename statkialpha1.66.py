...
class Turet():
    def __init__(self, pozycjax, pozycjay, obraz, firerate, vx, vy, dmg, range):
        self.obraz = obraz
...
while True:
    ...
    if opcjemenu == 3:
        ...
        while True:
            ...
            if click[0] and 70 < mouse[0] < 130 and 615 < mouse[1] < 675 and zmiennatrzymaszturet == 0 and kasa >= 30:
                lista_turet.append(Turet(70, 615, 1, 1, 2, 2, 1,600))
                kasa-=30
            ...
            for b in lista_turet:
                ...
                if b.x < mouse[0] < b.x + 60 and b.y < mouse[1] < b.y + 60 and b.postawiony == 0:
                    if click[0]:
                ...
                if suma == 0:
                    if zmiennatrzymaszturet == 1:
                        ...
                        pygame.draw.circle(obraz,[0,0,0],(mouse[0],mouse[1]),b.range,2)
                        obraz.blit(turet1, [mouse[0] - 30, mouse[1] - 30])
            ...
            for j in lista_enemy:
                for i in lista_turet:
                    if zasieg(i.x, i.y, j.x, j.y, i.range) == 1:
                        ...
                        if i.magazynek<4:
                            my_missile_list.append(Projectile(i.x+30,i.y+30,-((i.x - j.x)*0.1+j.vx),-((i.y - j.y)*0.1+j.vy),random.randint(-50,50),pocisk1,i.dmg,i.range))
                            i.magazynek=0
            ...
            for b in my_missile_list:
                ...
                for bb in lista_enemy:
                    if bb.x <b.x < bb.x + 60 and bb.y <b.y < bb.y + 60:
                        b.istnieje=0
                        #lista_enemy.remove(bb)
                        bb.hp -= b.dmg
                        if bb.hp <= 0:
                            lista_enemy.remove(bb)
                if b.istnieje ==0:
            ...
            if globalnytimer == 29:
                lista_enemy.append(Enemy(1280, 220, 0, 100, 0, 0, 10))
            if globalnytimer == 60:
                lista_enemy.append(Enemy(1280, 220, 0, 100, 0, 0, 10))
