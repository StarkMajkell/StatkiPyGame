...
class Enemy():
    ...
    def trasa(self):
        #self.x=listakropekkordyx[self.zmiennai]
        #self.y=listakropekkordyy[self.zmiennai]
        ...
        while True:
            ...
            if globalnytimer == 5:
                if lokalnytimer2 < 33:
                    ...
                    lokalnytimer2 = 0
                    lista_enemy.append(Enemy(listakropekkordyx[0], listakropekkordyy[0], 1, 1000, 0, 0, 10))
