...
class paski():
    ...
    def rusuj(self):
        obraz.blit(self.grafa, [self.x, self.y])
...
while True:
    ...
    tabPaskow.append(paski(life, 0, 1))
    tabPaskow.append(paski(life, szerokoscOkna - 200, 1))
    tabPaskow.append(paski(life, 0, wysokoscOkna - 21))
    tabPaskow.append(paski(life, szerokoscOkna - 200, wysokoscOkna - 21))
    ##########################################################################################################
    ##########################################################################################################
