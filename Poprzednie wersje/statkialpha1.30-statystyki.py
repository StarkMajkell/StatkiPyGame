...
class Statek():
    ...
    def update(self):
        if self.player == 1:
            tab = ruch(pygame.K_w, pygame.K_s, pygame.K_a, pygame.K_d)
            self.x += tab[1]
            self.y += tab[0]
        #######################################
        if self.player == 2:
            tab = ruch(pygame.K_LEFT, pygame.K_RIGHT, pygame.K_UP, pygame.K_DOWN)
            self.x += tab[1]
            self.y += tab[0]
        ########################################
        if self.player == 3:
            tab = ruch(pygame.K_j, pygame.K_l, pygame.K_i, pygame.K_k)
            self.x += tab[1]
            self.y += tab[0]
        #########################################
        if self.player == 4:
            tab = ruch(pygame.K_KP4, pygame.K_KP6, pygame.K_KP8, pygame.K_KP5)
            self.x += tab[1]
            self.y += tab[0]
    ...
    def shot(self):
        if pygame.key.get_pressed()[pygame.K_f]:
            if self.player == 1:
                my_missile_list.append(Projectile(self.x+self.pozycjaxshot, self.y+self.pozycjayshot, self.predkoscxshot, self.predkoscyshot, rozrzut*self.modyfikatorrozrzutu + (self.modyfikatorrozstrzalu * 0),self.rodzajpocisku))
                pifpaf()
