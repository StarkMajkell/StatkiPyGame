    ...
    if opcjemenu == 2:
        while True:
            ...
            if 212 < mouse[0] < 382:
                ...
                if click[0]:
                    startmouse = mouse[1]-wysokoscOkna
                    rollm=mouse[1]+startmouse
                else:
                    rollmstatic+=rollm
                    rollm=0
            ...
            if 212 < mouse[0] < 252 and 80 < mouse[1] < 120:
                if click[0]:
                    obraz.blit(przycisk4, [212, 80+rollm+rollmstatic])
                    lista_statków[0].basehp +=1
                else:
                    obraz.blit(przycisk2, [212, 80+rollm+rollmstatic])
            if 338< mouse[0] < 378 and 80 < mouse[1] < 120:
                if click[0]:
                    obraz.blit(przycisk3, [338, 80+rollm+rollmstatic])
                    if lista_statków[0].basehp > 1:
                        lista_statków[0].basehp -= 1
                else:
                    obraz.blit(przycisk2, [338, 80+rollm+rollmstatic])

            obraz.blit(przycisk4, [212, 160+rollm+rollmstatic])
            obraz.blit(przycisk3, [338, 160+rollm+rollmstatic])
            obraz.blit(przycisk4, [212, 240+rollm+rollmstatic])
            obraz.blit(przycisk3, [338, 240+rollm+rollmstatic])
            obraz.blit(przycisk4, [212, 320+rollm+rollmstatic])
            obraz.blit(przycisk3, [338, 320+rollm+rollmstatic])
            obraz.blit(przycisk4, [212, 400+rollm+rollmstatic])
            obraz.blit(przycisk3, [338, 400+rollm+rollmstatic])
            obraz.blit(przycisk4, [212, 480+rollm+rollmstatic])
            obraz.blit(przycisk3, [338, 480+rollm+rollmstatic])
