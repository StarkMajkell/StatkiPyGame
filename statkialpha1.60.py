...
while True:
    ...
    if opcjemenu == 0:
        while True:
            ...
            obraz.blit(przyciskdefence, [4, 84])
            obraz.blit(przyciskback, [szerokoscOkna - 220, wysokoscOkna - 76])




            if 4 < mouse[0] < 224 and 40 < mouse[1] < 76:
                obraz.blit(przycisksettings1, [4, 46])
                if click[0]:
                    opcjemenu = 2
                    break
            else:
                obraz.blit(przycisksettings, [4, 44])
            if 4 < mouse[0] < 224 and 80 < mouse[1] < 116:
                obraz.blit(przyciskdefence1, [4, 86])
                if click[0]:
                    opcjemenu = 3
                    break
