...
while True:
    ...
    if opcjemenu == 3:
        ...
        while True:
            ...
            if click[0] and 30 < mouse[0] < 90 and 600 < mouse[1] < 660 and zmiennatrzymaszturet ==0:
                lista_turet.append(Turet(30,600,1,1,2,2,1,100))
                print('Dodalem nowy turet')

            for b in lista_turet:
                b.update()
                if b.x < mouse[0] < b.x+60 and b.y < mouse[1] <b.y+60:
                    if click[0]:
                        zmiennatrzymaszturet=1

                if 580 < mouse[0] < 1250 and 140 < mouse[1] <180:
                ...
                if not 580 < mouse[0] < 1250 or not 140 < mouse[1] <180:
                    if zmiennatrzymaszturet == 1:
            ...
            if globalnytimer ==34:
                lista_enemy.append(Enemy(1200, 220, 0, 100, 3, 3, 10))
