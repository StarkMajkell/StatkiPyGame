...
class Player():
    ...
    def update(self):
        ...
        self.x += self.chodzenie[0]*3*(self.kuca+0.2)
        self.y += self.chodzenie[1]*3*(self.kuca+0.2)
    ...
    def kick(self):
        if self.animacjakop > 0:
            ...
            self.animacjakop=8
            if self.kierunek ==3:
                lista_efektów.append(Efekts(self.x-7,self.y+25,0))
                pygame.mixer.Sound.play(kick)
            if self.kierunek ==1:
                lista_efektów.append(Efekts(self.x+16,self.y+25, 0))
                pygame.mixer.Sound.play(kick)
    ...
    def punch(self):
        if self.animacjapunch > 0:
            ...
            self.animacjapunch = 8
            if self.kierunek == 3:
                lista_efektów.append(Efekts(self.x - 7, self.y + 10, 0))
                pygame.mixer.Sound.play(punch)
            if self.kierunek == 1:
                lista_efektów.append(Efekts(self.x + 16, self.y + 10, 0))
                pygame.mixer.Sound.play(punch)
...
while True:
    ...
    if opcjemenu == 5:
        ...
        while True:
            ...
            Janek.update()
            if pygame.key.get_pressed()[pygame.K_SPACE] and Janek.wlocie ==0 and Janek.kuca==1:
                Janek.wlocie=1
            if Janek.wlocie==1:
                Janek.skok()
            if pygame.key.get_pressed()[pygame.K_i] and Janek.kopie ==0 and Janek.bije==0and Janek.kuca==1:
                Janek.kopie=1
            if Janek.kopie==1:
                Janek.kick()
            if pygame.key.get_pressed()[pygame.K_o] and Janek.kopie ==0 and Janek.bije==0and Janek.kuca==1:
                Janek.bije=1
            if pygame.key.get_pressed()[pygame.K_p] and Janek.kopie ==0 and Janek.bije==0:
                Janek.kuca=0
            else:
                Janek.kuca=1
            if Janek.bije==1:
