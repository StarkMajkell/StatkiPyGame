...
##Klasa gracza
class Statek():
    def __init__(self,pozycjax,pozycjay,nrstatku,player):
        self.image = nrstatku
        self.x = pozycjax
        self.y = pozycjay
        self.player = player
    ...
    def shot(self):
        if pygame.key.get_pressed()[pygame.K_f]:
            if self.player == 1:
                my_missile_list.append(Projectile(self.x+30, self.y+30, 2.7, 0, rozrzut + (75 * ruchyWS())))
                pifpaf()
...
czarek=Statek(50,50,statekGrafika_1,3)
