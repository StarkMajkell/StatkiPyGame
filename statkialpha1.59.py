...
while True:
    ...
    if opcjemenu == 0:
        while True:
            ...
            obraz.blit(menuopcje2,[0,0])
            obraz.blit(menuopcje1,[0,0])

            obraz.blit(przyciskstart, [4, 4])
            if 4 < mouse[0] < 224 and 0 < mouse[1] <  40 :
                obraz.blit(przyciskstart1, [4, 6])
                if click[0]:
                    opcjemenu=1
                    break


            obraz.blit(przycisksettings, [4, 44])
            obraz.blit(przycisksilnik, [4, 84])
    ...
    if opcjemenu == 2:
        while True:
            ...
            mouse = pygame.mouse.get_pos()
            click = pygame.mouse.get_pressed()
            mnoznikx=(mouse[0]-1170)*0.14
            mnozniky = (mouse[1] - 318)*0.26
            ...
            lista_statków[0].energiaregen += przyciski(240)
            ...
            energie1 = lista_statków[0].baseenergia
            energie1 = str(energie1)
            label2 = czcionka.render(energie1, 1, kolorNapisu)
            obraz.blit(label2, (260, 163 + ykoncowy))
            energiaregen1 = lista_statków[0].energiaregen
            energiaregen1 = str(energiaregen1)
            label2 = czcionka.render(energiaregen1, 1, kolorNapisu)
            ...
            lista_statków[1].energiaregen += przyciski(240 + step2)
            ...
            energie2 = lista_statków[1].baseenergia
            energie2 = str(energie2)
            label2 = czcionka.render(energie2, 1, kolorNapisu)
            obraz.blit(label2, (260, 163 + step2 + ykoncowy))
            energiaregen2 = lista_statków[1].energiaregen
            energiaregen2 = str(energiaregen2)
            label2 = czcionka.render(energiaregen2, 1, kolorNapisu)
            ...
            lista_statków[2].energiaregen += przyciski(240 + step3)
            ...
            energie3 = lista_statków[2].baseenergia
            energie3 = str(energie3)
            label2 = czcionka.render(energie3, 1, kolorNapisu)
            obraz.blit(label2, (260, 163 + step3 + ykoncowy))
            energiaregen3 = lista_statków[2].energiaregen
            energiaregen3 = str(energiaregen3)
            label2 = czcionka.render(energiaregen3, 1, kolorNapisu)
            ...
            lista_statków[3].energiaregen += przyciski(240 + step4)
            ...
            energie4 = lista_statków[3].baseenergia
            energie4 = str(energie4)
            label2 = czcionka.render(energie4, 1, kolorNapisu)
            obraz.blit(label2, (260, 163 + step4 + ykoncowy))
            energiaregen4 = lista_statków[3].energiaregen
            energiaregen4 = str(energiaregen4)
            label2 = czcionka.render(energiaregen4, 1, kolorNapisu)
                ...
                for i in range(x, y):
                    if i != x:
                        if hitBox(lista_statków[x].x, lista_statków[x].y, lista_statków[i].x, lista_statków[i].y,
                            ...
                            odepchnieciex = lista_statków[x].x -lista_statków[i].x
                            lista_statków[i].x -= odepchnieciex/4
                            odepchnieciey = lista_statków[x].y -lista_statków[i].y
                            lista_statków[i].y -= odepchnieciey/4

                            odepchnieciex = lista_statków[i].x -lista_statków[x].x
                            lista_statków[x].x -= odepchnieciex/4
                            odepchnieciey = lista_statków[i].y -lista_statków[x].y
                            lista_statków[x].y -= odepchnieciey/4
